                                                            ...
                                                            <form method="POST" action="{{ route('updateleadcontact')}}">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <input type="text" id="full_name" name="full_name" value="{{ old('full_name', count($contact) > 0 ? $contact[0]->name : '') }}" class="form-control mb-3">
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <input type="number" id="phone" name="phone" value="{{ old('phone', count($contact) > 0 ? $contact[0]->phone : '') }}"  class="form-control mb-3"> 
                                                                    </div>
                                            
                                                                    <div class="col-md-6">
                                                                        <label for="email" class="form-label">Enter Email <span class="text-danger">*</span></label>
                                                                        <input type="email" id="email" name="email" value="{{ old('email', count($contact) > 0 ? $contact[0]->email : '') }}" class="form-control mb-3">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <input type="date" id="birthday" value="{{ old('birthday', count($contact) > 0 ? $contact[0]->birthday : '') }}" name="birthday" class="form-control">
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <label for="address" class="form-label">Please Enter Address <span class="text-danger">*</span></label>
                                                                        <input name="address" id="address" value="{{ old('address', count($contact) > 0 ? $contact[0]->address : '') }}" class="form-control mb-3"/>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <textarea name="description" id="description" class="form-control mb-3">{{ old('description', count($contact) > 0 ? $contact[0]->description : '') }}</textarea>
                                                                    </div>
                                                                </div>
